...
import { Truck, Plus, Phone, MapPin } from 'lucide-react';
      ...
      <div className="ledger-container">
        {suppliers.map(s => (
          <div key={s.id} className="premium-card p-24">
            <div className="supplier-header" style={{display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px'}}>
          ...
          <div className="modal-content premium-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-footer">
                ...
                <button type="submit" className="confirm-btn">Save Supplier</button>
              </div>
            </form>
          </div>
        </div>
